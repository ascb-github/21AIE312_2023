...
"}")
    ...
    def upload_image(self):
        ...
        model_files = {
           # "VGG16": "chest_xray_vgg.h5",
            "ResNet": "chest_xray_resnet.h5",
            "AlexNet": "chest_xray_alexnet.h5",
            "Inception": "chest_xray_inception.h5"
        }

        model_name, _ = QtWidgets.QInputDialog.getItem(
            self.frame,
            "Select Model",
            "Choose a model:",
    ...
    def predict_result(self):
        prediction_label = QtWidgets.QLabel(self.frame)
        prediction_label.setGeometry(QtCore.QRect(80, 480, 591, 41))
        font = QtGui.QFont()
        font.setPointSize(18)
        font.setBold(True)
        font.setWeight(75)
        prediction_label.setFont(font)
        prediction_label.setObjectName("prediction_label")
        ...
        layout = QtWidgets.QVBoxLayout(self.frame)  # Add this line to create a layout
        layout.addWidget(prediction_label)

        ## Add the following line to set the layout for self.frame
