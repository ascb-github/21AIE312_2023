...
for category in categories:
    ...
    for img in os.listdir(path):
        ...
        img = Image.open(img_path).convert("RGB")  # Keep images in RGB format for VGG-16
        img = img.resize((224, 224))  # Resize image to (224, 224) for VGG-16
...
with open('/content/drive/MyDrive/Colab Notebooks/h5files/VGG16_model.json', "w") as json_file:
    json_file.write(model_json)

model.save_weights('/content/drive/MyDrive/Colab Notebooks/h5files/VGG16_model.h5')
